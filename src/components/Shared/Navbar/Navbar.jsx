                ...
                <div className="flex items-center justify-between h-[86px]">
                    ...
                    <div className="hidden lg:flex items-center gap-3">
                        <div className="flex items-center bg-[#17171C] border border-white/5 rounded-2xl px-2 py-2 shadow-[0_0_30px_rgba(255,255,255,0.02)]">
                            ...
                            <Link
                                href="/register"
                                className="bg-[#F5F5F7] text-[#0B0B0F] text-sm font-semibold px-6 py-3 rounded-xl hover:bg-white transition-all duration-300"
                            >
                                Get Started
                            </Link>
                        </div>
            ...
            >
                <div className="mx-4 mb-4 bg-[#17171C] border border-white/5 rounded-2xl p-4 shadow-2xl">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <Link
                            href="/login"
                            className="text-[#7C5CFF] text-sm font-semibold px-4 py-3 rounded-xl hover:bg-[#7C5CFF]/10 transition"
                        >
                            Sign In
                        </Link>
